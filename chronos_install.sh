...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='chronos.conf'
CONFIGFOLDER='/root/.chronos'
COIN_DAEMON='chronosd'
COIN_CLI='chronos-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CRNofficial/chronos/releases/download/1.0.1/chronos-1.0.1-ubuntu-compiled-16.04.tar.gz'
